...
public class SampleServlet extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<b>Hello 한글도 처리 됨</b>");
		
		List<StudentVO> list = mapper.studentList();
		
		for(StudentVO svo : list) {
			out.println("<li><a href='jsp/student.jsp?sno=" + svo.getStudentNumber() + "'>" + svo.getStudentNumber() + ", " + svo.getStudentName() + "</a></li>");
		}
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 개발자가 실행흐름 주도x => WebApplicationServer 주도 = 제어의 역전
