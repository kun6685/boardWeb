...
<table class="table">
	...
	SearchVO aaa = (SearchVO) request.getAttribute("aaaa");
	%>
	<tbody>
		<%
		...
		<tr>
			...
			<td><a href="board.do?bno=<%=board.getBoardNo()%>"> <%=board.getTitle()%></a>
			</td>
...
<nav aria-label="Page navigation example">
	<ul class="pagination justify-content-center">
		...
		%>
		<li class="page-item"><a class="page-link"
			href="boardList.do?page=<%=i%>&searchCondition=<%=aaa.getSearchCondition() %>&keyword=<%=aaa.getKeyword() %>"><%=i%></a></li>
		<%
		}
		}
		%>
